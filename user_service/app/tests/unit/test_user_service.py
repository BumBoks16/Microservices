...
def test_get_repo_users(user_service: UserService):
    assert user_service.get_users() == [User(id=UUID('85db966c-67f1-411e-95c0-f02edfa5464a'), username='user1', email='user1@example.com'),User(id=UUID('31babbb3-5541-4a2a-8201-537cdff25fed'), username='user2', email='user2@example.com'),User(id=UUID('45309954-8e3c-4635-8066-b342f634252c'), username='user3', email='user3@example.com'),User(id=UUID('88a4f768-3196-41a6-bc97-8b5dfb4f5d76'), username='user4', email='user4@example.com'),User(id=UUID('1dc2a3f3-d0bc-4c78-8a2d-04d1e2434f4c'), username='user5', email='user5@example.com')]
